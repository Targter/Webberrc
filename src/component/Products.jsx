                    ...
                    <div className="p-6">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          ...
                          className="inline-flex items-center text-md font-medium text-black hover:text-green-700 transition-colors group/download"
                        >
                          <svg
                        ...
                        <button className="inline-flex items-center text-sm font-medium bg-gradient-to-r from-[#3b82f6] via-[#06b6d4] to-[#10b981] bg-clip-text text-transparent  transition-colors group/btn">
