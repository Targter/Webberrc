  ...
  const products = [
    {
      title: "chip1",
      description:
        "Handcrafted Italian leather briefcase with premium hardware. Perfect for the modern professional who values both style and functionality.",
      image: "",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br ">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-16 sm:py-24">
          <div className="text-center">
            ...
            <p className="text-xl text-slate-800 max-w-3xl mx-auto leading-relaxed">
              ...
              each chosen for its exceptional quality, timeless design, and
      ...
      <div className="max-w-7xl mx-auto px-6 pb-20">
        <HoverEffect items={products} className="max-w-6xl mx-auto" />
      </div>
