...
export const Achieve = ({
  ...
  const ParallaxLogos = ({
    ...
    return (
      <div className="w-full overflow-hidden relative" ref={containerRef}>
        ...
        <div className="absolute right-0 top-0 w-24 sm:w-32 h-full bg-gradient-to-l from-white via-white/80 to-transparent dark:from-gray-900 dark:via-gray-900/80 z-10 pointer-events-none" />
  ...
  return (
    <section className="relative w-full py-24 sm:py-28 overflow-hidden">
