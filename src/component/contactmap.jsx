...
import { ChevronDown, MapPin, Phone, Mail, Send, Plus, Minus } from "lucide-react";
                  ...
                  <div className="relative w-6 h-6 flex-shrink-0">
                    <Plus
                      className={`absolute w-6 h-6 text-blue-500 transition-all duration-300 ${
                        openFAQ === index ? "opacity-0 rotate-90" : "opacity-100"
                      }`}
                    />
                    <Minus
                      className={`absolute w-6 h-6 text-green-500 transition-all duration-300 ${
                        openFAQ === index ? "opacity-100 rotate-0" : "opacity-0 -rotate-90"
                      }`}
                    />
                  </div>
                </button>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          <div className="grid lg:grid-cols-5 gap-12">
            ...
            <div className="lg:col-span-3">
              <div className="relative">
                <div className="absolute -inset-2 bg-gradient-to-r from-slate-800 to-slate-700 rounded-3xl blur-sm"></div>
                <div className="relative bg-gradient-to-br from-slate-800 to-slate-900 rounded-3xl p-8 border border-slate-700/50">
                  ...
                  <div className="space-y-6">
                    ...
                    >
                      ...
                      <Send className={`w-5 h-5 mr-3 transition-transform duration-300 ${isHovered ? 'translate-x-1' : ''}`} />
      ...
      <div className="bg-gradient-to-br from-gray-100 to-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="relative group">
            <div className="absolute -inset-2 bg-gradient-to-r from-blue-500/20 to-green-400/20 blur-xl rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
