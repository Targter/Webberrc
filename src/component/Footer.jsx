    ...
    <footer className="bg-[#0d0d0d] text-gray-300 pt-12 pb-6 px-4 sm:px-8 md:px-12">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 border-b border-gray-700 pb-10">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            <li><a href="#" className="hover:bg-gradient-to-r hover:from-blue-500 hover:to-green-400 hover:bg-clip-text hover:text-transparent transition-all duration-200">Home</a></li>
            <li><a href="#" className="hover:bg-gradient-to-r hover:from-blue-500 hover:to-green-400 hover:bg-clip-text hover:text-transparent transition-all duration-200">About Us</a></li>
            <li><a href="#" className="hover:bg-gradient-to-r hover:from-blue-500 hover:to-green-400 hover:bg-clip-text hover:text-transparent transition-all duration-200">Products</a></li>
            {/* <li><a href="#" className="hover:text-white">Certifications</a></li> */}
            <li><a href="#" className="hover:bg-gradient-to-r hover:from-blue-500 hover:to-green-400 hover:bg-clip-text hover:text-transparent transition-all duration-200">Contact</a></li>
          </ul>
        </div>
      ...
      <div className="max-w-7xl mx-auto mt-6 flex flex-col sm:flex-row justify-between items-center text-xs text-gray-500">
        ...
        <div className="flex gap-4 mt-2 sm:mt-0">
          <a href="#" className="hover:bg-gradient-to-r hover:from-blue-500 hover:to-green-400 hover:bg-clip-text hover:text-transparent transition-all duration-200">Privacy Policy</a>
          <a href="#" className="hover:bg-gradient-to-r hover:from-blue-500 hover:to-green-400 hover:bg-clip-text hover:text-transparent transition-all duration-200">Terms of Use</a>
