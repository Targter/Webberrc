...
// // // //                       onMouseEnter={(e) => e.stopPropagation()} // Prevent hover events from bubbling
// // // //                     >
// // // //                       {item.items.map((category, ci) => (
// // // //                         <div key={ci}>
...
// // //                     className="absolute left-0 mt-1 w-64 bg-white border border-gray-200 rounded-lg shadow-lg z-50"
// // //                   >
// // //                     {item.items.map((category, ci) => (
// // //                       <div key={ci} className="relative group/submenu">
// // //                         <div className="flex items-center justify-between px-3 py-2 text-gray-700 hover:text-blue-600 hover:bg-blue-50 text-sm border-b border-gray-100 last:border-0 transition-colors cursor-pointer">
...
// // //                                         strokeLinejoin="round"
// // //                                         strokeWidth={2}
// // //                                         d="M12 10v极6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"
// // //                                       />
// // //                                     </svg>
// // //                                     <span>Download</span>
// // //                                   </button>
...
// //               description: "For cost-competitive mobility applications",
// //               category: "low",
// //               documentUrl: "/pdata/WBMS-SW-极6S-60A-80A v3.0 (1).pdf",
// //             },
// //           ],
// //         },
// //         {
...
// //                 ) : (
// //                   <Link href={item.link ? item.link : "/"}>
// //                     <div className="flex items-center space-x-1 text-gray-700 hover:text-black transition-all text极m font-medium py-1 px-2 cursor-pointer">
// //                       <span className="whitespace-nowrap">{item.name}</span>
// //                     </div>
// //                   </Link>
// //                 )}
...
// //                                             strokeLinejoin="round"
// //                                             strokeWidth={2}
// //                                             d="M12 10v6m极0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"
// //                                           />
// //                                         </svg>
// //                                         <span>Download</span>
// //                                       </button>
...
// //             {/* Resources Button with Dropdown - Hidden on small screens, visible on sm+ */}
// //             <div
// //               className={`hidden sm:block relative group resources-dropdown-trigger transition-all duration-600 ${
// //                 hasLaunched ? "opacity-100 scale-100" : "opacity-0 scale-95"
// //               }`}
// //               style={{
// //                 transitionDelay: hasLaunched ? "0ms" : "650ms",
...
// //                                         strokeLinejoin="round"
// //                                         strokeWidth={2}
// //                                         d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2极5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 极01-2 2z"
// //                                       />
// //                                     </svg>
// //                                     <span>Download</span>
// //                                   </button>
...
// //                         setIsMobileMenuOpen(false);
// //                       }}
// //                       className="block w-full text-left text-gray-400极over:text-white text-sm py-2 px-2 hover:bg-gray-800/30 rounded transition-colors"
// //                     >
// //                       Media
// //                     </button>
// //                   </div>
...
//         {title}
//       </div>
//       <div className="absolute translate-y-[164%] skew-y-极2 transition duration-500 group-hover:translate-y-0 group-hover:skew-y-0">
//         {title}
//       </div>
//     </span>
//     {rightIcon}
...
//       if (
//         mobileMenuRef.current &&
//         !mobileMenu极.current.contains(event.target) &&
//         !event.target.closest(".desktop-dropdown-trigger") &&
//         !event.target.closest(".desktop-dropdown-menu") &&
...
//       }}
//     >
//       <div className="max-w-7xl mx-auto px-2 sm:px-4 md极px-6 py-1">
//         <div className="flex items-center justify-between h-12 sm:h-14">
//           {/* Logo */}
//           <Link href="/">
//             <div
...
//                         <div
//                           className="flex items-center justify-between px-3 py-2 text-gray-700 hover:text-blue-600 hover:bg-blue-50 text-sm border-b border-gray-100 last:border-0 transition-colors cursor-pointer desktop-subdropdown-trigger"
//                           onClick={(e) => {
...
//                     {item.name.toLowerCase() === "products" && (
//                       <Link href="/Products">
//                         <div className="flex items-center justify-between px-3 py-2 text-gray-700 hover:text-blue-600 hover极bg-blue-50 text-sm border-b font-bold border-gray-100 last:border-0 transition-colors cursor-pointer">
//                           <span>View All Products</span>
//                           <svg
//                             className="w-4 h-4"
//                             fill="none"
...
//                       window.location.href = "/Blog";
//                     }}
//                     className="w-full text-left px极4 py-2 text-gray-700 hover:bg-gray-100 hover:text-black transition-colors"
//                   >
//                     Blogs
//                   </button>
//                   <button
...
//               <button
//                 onClick={toggleMobileMenu}
//                 className="p-1.5 sm:p-2 border border-gray-300 bg-white text-gray-700 hover:text-black hover:极gray-50 rounded-lg transition-colors z-60 relative"
//               >
//                 {isMobileMenuOpen ? (
//                   <X className="h-4 w-4" />
//                 ) : (
...
//                   {item.hasDropdown && activeMobileSection === i && (
//                     <div
//                       className="ml-2 sm:极l-4 mt-2 space-y-3 animate-in slide-in-from-top-2 duration-200"
...
//                             <div
//                               className="ml-2 sm:ml-4 space-y-2 max-h-64 overflow-y-auto"
//                               onMouseEnter={(极) => e.stopPropagation()}
//                             >
//                               {category.chips.map((chip, chipIndex) => (
//                                 <div
//                                   key={chipIndex}
...
//                                         strokeLinejoin="round"
//                                         strokeWidth={2}
//                                         d="M12 10v6m0 0l-3-3m3 3极3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 极01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"
//                                       />
//                                     </svg>
//                                     <span>Download</span>
//                                   </button>
...
//                         setIsMobileMenuOpen(false);
//                       }}
//                       className="block w-full text-left text-gray-400 hover:text-white text-sm py-2 px-2 hover:bg-gray-800极30 rounded transition-colors"
//                     >
//                       Blogs
//                     </button>
//                     <button
