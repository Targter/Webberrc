          ...
          >
            ...
            <div className="space-y-4">
              <p className="text-lg text-gray-600">
                Our diverse team brings together expertise from various fields to create a culture of 
                continuous learning and innovation.
              </p>

              <div className="flex gap-4">
                <button className="px-6 py-3 border-2 border-purple-500 text-purple-500 rounded-xl hover:bg-purple-500 hover:text-white transition-all duration-300 font-medium">
                  About us
                </button>
              </div>
            </div>
